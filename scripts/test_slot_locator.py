...
from led_eval.classic_cv.locators import SlotBasedLEDLocator, TrackingLEDLocator
from led_eval.utils.config_loader import load_yaml_config
from led_eval.utils.image_debug import draw_detection_debug_image, save_debug_image
...
def main() -> None:
    ...
    if locator_cfg.get("type", "slot_based") != "slot_based":
        raise ValueError("Fuer test_slot_locator.py muss locator.type=slot_based gesetzt sein.")
