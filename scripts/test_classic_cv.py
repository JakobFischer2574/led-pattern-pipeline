...
from led_eval.utils.image_debug import save_detection_debug_artifacts
...
def main() -> None:
    ...
    parser.add_argument("--output-csv", default="outputs/development_runs/classic_cv_results.csv")
    args = parser.parse_args()

    cfg = load_yaml_config(args.config)
    layout = load_yaml_config(args.layout).get("leds")
    if not isinstance(layout, dict):
        raise ValueError("Ungueltiges Layout: 'leds' fehlt oder ist kein dict")
